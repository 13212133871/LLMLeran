...
![GPT-2 总览](images/illustrated-gpt2/01-openAI-GPT-2-3.png)
...
![手机输入法预测下一个词](images/illustrated-gpt2/02-swiftkey-keyboard.png)
...
![GPT-2 不同尺寸](images/illustrated-gpt2/03-gpt2-sizes.png)
...
![原始 Transformer 的编码器和解码器](images/illustrated-gpt2/04-transformer-encoder-decoder.png)
...
![几种 Transformer 系列结构](images/illustrated-gpt2/05-gpt-2-transformer-xl-bert-3.png)
...
![GPT-2 尺寸参数](images/illustrated-gpt2/06-gpt2-sizes-hyperparameters-3.png)
...
![GPT-2 每次输出一个 token](images/illustrated-gpt2/07-gpt-2-output.gif)
...
![自回归生成](images/illustrated-gpt2/08-gpt-2-autoregression-2.gif)
...
![编码器块](images/illustrated-gpt2/09-transformer-encoder-block-2.png)
...
![解码器块](images/illustrated-gpt2/10-transformer-decoder-block-2.png)
...
![解码器块中的遮罩自注意力](images/illustrated-gpt2/11-transformer-decoder-block-self-attention-2.png)
...
![普通自注意力和遮罩自注意力](images/illustrated-gpt2/12-self-attention-and-masked-self-attention.png)

普通自注意力像一场全班讨论，每个词都能听到所有词。遮罩自注意力像按时间顺序写日记：今天写到这里，只能参考今天之前的内容，明天发生的事情不能提前拿来用。

## 8. Decoder-only：GPT-2 只留下生成需要的部分

![Decoder-only Transformer](images/illustrated-gpt2/13-transformer-decoder-intro.png)
...
![GPT-2 层堆叠](images/illustrated-gpt2/14-gpt-2-layers-2.png)
...
![起始 token 生成第一个词](images/illustrated-gpt2/15-gpt2-simple-output-2.gif)
...
![把输出接回输入继续预测](images/illustrated-gpt2/16-gpt-2-simple-output-3.gif)
...
![token embedding 矩阵](images/illustrated-gpt2/17-gpt2-token-embeddings-wte-2.png)
...
![位置编码矩阵](images/illustrated-gpt2/18-gpt2-positional-encoding.png)
...
![token 向量加位置向量](images/illustrated-gpt2/19-gpt2-input-embedding-positional-encoding-3.png)
...
![token 向量穿过 block](images/illustrated-gpt2/20-gpt2-transformer-block-vectors-2.png)
...
![it 关注 a robot](images/illustrated-gpt2/21-gpt2-self-attention-example-2.png)
...
![文件柜类比](images/illustrated-gpt2/22-self-attention-example-folders-3.png)
...
![Query 和 Key 打分](images/illustrated-gpt2/23-self-attention-example-folders-scores-3.png)
...
![按权重混合 Value](images/illustrated-gpt2/24-gpt2-value-vector-sum.png)
...
![输出投影到词表](images/illustrated-gpt2/25-gpt2-output-projection-2.png)
...
![词表中每个 token 的分数](images/illustrated-gpt2/26-gpt2-output-scores-2.png)
...
![选出下一个 token](images/illustrated-gpt2/27-gpt2-output.png)
...
![放大向量示意](images/illustrated-gpt2/28-zoom-in.png)
...
![GPT-2 中的自注意力](images/illustrated-gpt2/29-gpt2-self-attention-1-2.png)
...
![普通自注意力三步](images/illustrated-gpt2/30-self-attention-summary.png)
...
![生成 Q、K、V](images/illustrated-gpt2/31-self-attention-1.png)
...
![Query 和所有 Key 打分](images/illustrated-gpt2/32-self-attention-2.png)
...
![对 Value 加权求和](images/illustrated-gpt2/33-self-attention-3-2.png)
...
![遮罩自注意力](images/illustrated-gpt2/34-masked-self-attention-2.png)
...
![把整段序列变成多道预测题](images/illustrated-gpt2/35-transformer-decoder-attention-mask-dataset.png)
...
![QK 矩阵和遮罩](images/illustrated-gpt2/36-queries-keys-attention-mask.png)
...
![三角遮罩](images/illustrated-gpt2/37-transformer-attention-mask.png)
...
![mask 后 softmax](images/illustrated-gpt2/38-transformer-attention-masked-scores-softmax.png)
...
![处理第一个 token](images/illustrated-gpt2/39-gpt2-self-attention-qkv-1-2.png)
...
![保存 Key 和 Value](images/illustrated-gpt2/40-gpt2-self-attention-qkv-2-2.png)
...
![复用旧的 Key 和 Value](images/illustrated-gpt2/41-gpt2-self-attention-qkv-3-2.png)
...
![输入向量生成 QKV](images/illustrated-gpt2/42-gpt2-self-attention-1.png)
...
![QKV 权重矩阵](images/illustrated-gpt2/43-gpt2-self-attention-2.png)
...
![拆出 Q、K、V](images/illustrated-gpt2/44-gpt2-self-attention-3.png)
...
![切分注意力头](images/illustrated-gpt2/45-gpt2-self-attention-split-attention-heads-1.png)
...
![多个注意力头并行](images/illustrated-gpt2/46-gpt2-self-attention-split-attention-heads-2.png)
...
![单个头打分](images/illustrated-gpt2/47-gpt2-self-attention-scoring.png)
...
![和所有历史 Key 打分](images/illustrated-gpt2/48-gpt2-self-attention-scoring-2.png)
...
![单个头对 Value 加权求和](images/illustrated-gpt2/49-gpt2-self-attention-multihead-sum-1.png)
...
![合并多个头](images/illustrated-gpt2/50-gpt2-self-attention-merge-heads-1.png)
...
![输出投影矩阵](images/illustrated-gpt2/51-gpt2-self-attention-project-1.png)
...
![注意力输出向量](images/illustrated-gpt2/52-gpt2-self-attention-project-2.png)
...
![前馈网络第一层](images/illustrated-gpt2/53-gpt2-mlp1.gif)
...
![前馈网络第二层](images/illustrated-gpt2/54-gpt2-mlp-2.gif)
...
![block 内权重](images/illustrated-gpt2/55-gpt2-transformer-block-weights-2.png)
...
![全模型权重](images/illustrated-gpt2/56-gpt2-weights-2.png)
...
![GPT-2 参数统计](images/illustrated-gpt2/57-gpt2-117-parameters.png)
...
![decoder-only 做翻译](images/illustrated-gpt2/58-decoder-only-transformer-translation.png)
...
![Wikipedia 摘要训练](images/illustrated-gpt2/59-wikipedia-summarization.png)
...
![decoder-only 摘要](images/illustrated-gpt2/60-decoder-only-summarization.png)
...
![音乐演奏编码](images/illustrated-gpt2/61-music-transformer-performance-encoding-3.png)

语言模型不一定只能处理自然语言。只要能把对象表示成离散序列，就可以尝试用类似方法建模。音乐里可以把音符、力度、时间等事件编码成 token。

![音乐事件表示](images/illustrated-gpt2/62-music-representation-example.png)
...
![音乐输入序列](images/illustrated-gpt2/63-music-transformer-input-representation-2.png)

这和文本里的 token 序列非常像。区别只是词表不再是文字片段，而是音乐事件。

![音乐中的自注意力](images/illustrated-gpt2/64-music-transformer-self-attention-2.png)
